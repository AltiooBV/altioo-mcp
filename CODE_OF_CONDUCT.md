...
This applies to every space this project has: issues, pull requests, review comments, commit
messages, and the mailboxes below. Report a problem to <conduct@altioo.com> — that address is
for conduct, and a suspected vulnerability goes to the private channels in
...
community leaders responsible for enforcement at <conduct@altioo.com>. All complaints will be

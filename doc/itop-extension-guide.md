...
[`doc/itop-branch-notes.md`](itop-branch-notes.md), which is dated and must be re-verified
...
[`doc/itop-branch-notes.md`](itop-branch-notes.md), which carries its own verified-on date.
